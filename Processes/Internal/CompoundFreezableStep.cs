...
namespace Reductech.EDR.Processes.Internal
{
    ...
    public sealed class CompoundFreezableStep : IFreezableStep, IEquatable<CompoundFreezableStep>
    {
        ...
        public Result<IReadOnlyCollection<(VariableName VariableName, ITypeReference type)>> TryGetVariablesSet
        {
            get
            {
                ...
                return result;
                 ...
                 Result<IReadOnlyCollection<(VariableName, ITypeReference)>> TryGetProcessMemberVariablesSet(StepMember processMember) =>
        ...
        /// <inheritdoc />
        public string ProcessName => StepFactory.StepNameBuilder.GetFromArguments(FreezableStepData);
