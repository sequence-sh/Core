...
namespace Reductech.EDR.Processes.Internal
{
    ...
    public abstract class CompoundStep<T> : ICompoundStep<T>
    {
        ...
        private IEnumerable<(string name, IStep process) > RunnableArguments
        {
            get
            {
                return GetType().GetProperties()
                    .Where(x => x.GetCustomAttribute<StepPropertyAttribute>() != null)
                    .Select(x => (x.Name, process: x.GetValue(this) as IStep))
        ...
        private FreezableStepData FreezableStepData
        {
            get
            {
                ...
                var arguments  = RunnableArguments
                 .ToDictionary(x => x.name, x => new StepMember(x.process!.Unfreeze()));
                ...
                return new FreezableStepData(processMembers);
            }
        }
