...
public static class Extensions
{
    ...
    ///// </summary>
    //public static Maybe<T> Maybe<T>(this T? str) where T : struct => str.HasValue
    //    ? CSharpFunctionalExtensions.Maybe<T>.From(str.Value)
    //    : CSharpFunctionalExtensions.Maybe<T>.None;
    ...
    //    from val in source where val.HasValue select val.Value;
