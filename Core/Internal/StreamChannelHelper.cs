...
namespace Reductech.EDR.Core.Internal
{
    ...
    public static class StreamChannelHelper
    {
        ...
        /// Converts a list of streams to a ChannelReader
        /// </summary>
        public static ChannelReader<(string text, T source)> ToChannelReader<T>(params (TextReader textReader, T source)[] streams)
        {
            ...
            static async Task WriteToChannel(TextReader textReader, T streamSource, ChannelWriter<(string line, T source)> channel)
            {
                while (true)
                {
