...
/// </summary>
public sealed class FreezableStepProperty :
    OneOfBase<VariableName, IFreezableStep, ImmutableList<IFreezableStep>>,
    IEquatable<FreezableStepProperty>
{
    /// <summary>
    ...
    /// </summary>
    public MemberType MemberType => Match(
        _ => MemberType.VariableName,
        _ => MemberType.Step,
        _ => MemberType.StepList
    );

    /// <summary>
    /// This, if it is a variableName
    /// </summary>
    public Maybe<VariableName> VariableName => Match(
        x => x,
        _ => Maybe<VariableName>.None,
        _ => Maybe<VariableName>.None
    );
    ...
    public override bool Equals(object? obj) => ReferenceEquals(this, obj)
                                             || obj is FreezableStepProperty other && Equals(other);
    ...
    /// Equals operator
    /// </summary>
    public static bool operator ==(FreezableStepProperty? left, FreezableStepProperty? right) =>
        Equals(left, right);
