...
namespace Reductech.EDR.Core.Steps
{
    ...
    public class EntityMapProperties : CompoundStep<Array<Entity>>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (mappings.IsFailure) return mappings.ConvertFailure<Array<Entity>>();

            var entityStream = await EntityStream.Run(stateMonad, cancellationToken);

            if (entityStream.IsFailure) return entityStream.ConvertFailure<Array<Entity>>();
    ...
    public class EntityMapPropertiesStepFactory : SimpleStepFactory<EntityMapProperties, Array<Entity>>
    {
        ...
        /// The instance.
        /// </summary>
        public static SimpleStepFactory<EntityMapProperties, Array<Entity>> Instance { get; } = new EntityMapPropertiesStepFactory();
    }
