...
namespace Reductech.EDR.Core.Steps
{
    ...
    public sealed class EntityMap : CompoundStep<Array<Entity>>
    {
        ...
        {
            return baseContext.TryCloneWithScopedStep(Variable, new ActualTypeReference(typeof(Entity)), scopedStep,
    ...
    public sealed class EntityMapStepFactory : SimpleStepFactory<EntityMap, Array<Entity>>
    {
        ...
        /// The instance.
        /// </summary>
        public static SimpleStepFactory<EntityMap, Array<Entity>> Instance { get; } = new EntityMapStepFactory();
    }
}