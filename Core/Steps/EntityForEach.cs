...
//            async ValueTask<Result<Unit, IError>> Apply(Entity entity, CancellationToken cancellation)
//            {
...
//            var finalResult = await entities.Value.ForEach(Apply, cancellationToken);
