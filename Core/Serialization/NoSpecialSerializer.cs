...
//        /// <inheritdoc />
//        public Result<string> TrySerialize(FreezableStepData data, StepFactoryStore stepFactoryStore) => Result.Failure<string>("This step does not support special serialization");
//    }
//}