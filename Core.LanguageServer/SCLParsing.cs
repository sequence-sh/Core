...
public static class SCLParsing2
{
    ...
    private class Visitor : SCLBaseVisitor<Result<FreezableStepProperty, IError>>
    {
            ...
            SCLParser.BooleanContext context)
        {
            ...
            var member = new FreezableStepProperty.Step(
                new SCLConstantFreezable<SCLBool>(SCLBool.Create(b), location),
                location
            );
            ...
            SCLParser.NumberContext context)
        {
            ...
            {
                var member = new FreezableStepProperty.Step(
                    new SCLConstantFreezable<SCLInt>(new SCLInt(num), location),
                    location
                );
            ...
            {
                var member = new FreezableStepProperty.Step(
                    new SCLConstantFreezable<SCLDouble>(new SCLDouble(d), location),
                    new TextLocation(context)
                );
            ...
            SCLParser.InterpolatedStringContext context)
        {
            ...
            var freezableStep = FreezableFactory.CreateFreezableInterpolatedString(
                steps,
                new TextLocation(context)
            );
