    ...
    protected override IEnumerable<ITestBaseCaseParallel> TestCases
    {
        get
        {
            yield return new ErrorTestFunction(
                ...
                new ErrorBuilder(ErrorCode_Core.MissingVariable, "<Foo>")
            );

            yield return new ErrorTestFunction(
                "ValueIf assert",
                new AssertTrue { Boolean = Constant(false) },
                new ErrorBuilder(ErrorCode_Core.AssertionFailed, "False")
            );
            ...
            yield return new ErrorTestFunction(
                ...
                new ErrorBuilder(ErrorCode_Core.WrongVariableType, "<Foo>", nameof(Boolean))
            ...
            yield return new ErrorTestFunction(
                ...
                new ErrorBuilder(ErrorCode_Core.AssertionFailed, nameof(AssertTrue))
            );
