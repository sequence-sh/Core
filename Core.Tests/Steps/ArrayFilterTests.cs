    ...
    public class ArrayFilterTests : StepTestBase<ArrayFilter<Entity>, Array<Entity>>
    {
        ...
        protected override IEnumerable<StepCase> StepCases
        {
            get
            {
                ...
                yield return new StepCase("Filter stuff with custom variable name",
                    new ForEach<Entity>
                    {
                        ...
                        Array = new ArrayFilter<Entity>
                        {
                            ...
                            Predicate = new EntityHasProperty() { Property = Constant("Foo"), Entity = GetVariable<Entity>("FilterVar") },
