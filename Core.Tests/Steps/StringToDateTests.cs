...
namespace Reductech.EDR.Core.Tests.Steps
{
    public class StringToDateTests : StepTestBase<StringToDate, DateTime>
    {
        ...
        protected override IEnumerable<StepCase> StepCases
        {
            get
            {
                yield return new StepCase("Convert string using default format",
                    new StringToDate
                    {
                        Date = Constant("2020/10/20 20:30:40")
                    },
                    new DateTime(2020, 10, 20, 20, 30, 40)
                );
                yield return new StepCase("Convert string using en-GB culture",
                    new StringToDate
                    {
                        Date = Constant("10/11/2020 20:30:40"),
                        Culture = Constant("en-GB")
                    },
                    new DateTime(2020, 11, 10, 20, 30, 40)
                );
                yield return new StepCase("Convert string using en-US culture",
                    new StringToDate
                    {
                        Date = Constant("10/11/2020 20:30:40"),
                ...
                yield return new StepCase("Convert string using custom format",
                    new StringToDate
                    {
                ...
                yield return new StepCase("Convert string using custom format and culture",
                    new StringToDate
                    {
        ...
        protected override IEnumerable<ErrorCase> ErrorCases
        {
            get
            {
                ...
                yield return new ErrorCase("Can't parse Date using inputFormat",
                    new StringToDate
                    {
                        Date = Constant("not a date"),
                        InputFormat = Constant("yyyy/MM/dd")
                    },
                    new ErrorBuilder(
